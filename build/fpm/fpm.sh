...
packages=(
  ...
  "deb base       amd64  8.1 20200930 $baseurl-php8.1-debian-x86-64+libssl3.tar.gz +libssl3"
  ...
  "deb base       arm64  8.1 20200930 $baseurl-php8.1-debian-aarch64.tar.gz"
  ...
  "deb base       arm64  8.1 20200930 $baseurl-php8.1-debian-aarch64+libssl3.tar.gz +libssl3"
