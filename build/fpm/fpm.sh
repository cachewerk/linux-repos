...
packages=(
  "deb base       amd64  8.2 20200930 $baseurl-php8.2-debian-x86-64.tar.gz"
  ...
  "deb base       amd64  8.2 20200930 $baseurl-php8.2-debian-x86-64+libssl3.tar.gz +libssl3"
  ...
  "deb base       arm64  8.2 20200930 $baseurl-php8.2-debian-aarch64.tar.gz"
  ...
  "deb base       arm64  8.2 20200930 $baseurl-php8.2-debian-aarch64+libssl3.tar.gz +libssl3"
